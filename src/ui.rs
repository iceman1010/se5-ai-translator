...
pub struct TranslatorApp {
    ...
    update_check_result: Arc<Mutex<Option<Result<Option<(String, String)>, String>>>>,
...
impl TranslatorApp {
    ...
    fn draw_settings_tab(&mut self, ui: &mut egui::Ui, ctx: egui::Context) {
        ui.group(|ui| {
            ui.heading("Settings");
            ui.add_space(8.0);
    ...
    fn draw_update_dialog(&mut self, ctx: &egui::Context) {
        ...
        egui::Window::new(&title)
            ...
            .show(ctx, |ui| {
                ui.vertical_centered(|ui| {
                    ui.label(format!("A new version is available!"));
                    ui.add_space(8.0);
